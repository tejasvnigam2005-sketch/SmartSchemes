  ...
  if (loading) {
    return (
      <div style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '0.875rem', color: '#6B7280' }}>Loading guide...</p>
      </div>
    );
  }
      ...
      <div className="stepper">
              ...
              <div className="stepper-content">
                ...
                {(isActive || isDone) && (
                  <div className="animate-fade-in" style={{ marginTop: '8px', paddingBottom: '16px' }}>
                    <p style={{ fontSize: '0.8125rem', color: '#6B7280', lineHeight: 1.5, marginBottom: '12px' }}>
                      {step.description}
                    </p>
                    {step.actionLink && isActive && (
                      <a href={step.actionLink} target="_blank" rel="noopener noreferrer" className="btn-ghost" style={{ background: '#F3F4F6', color: '#3B82F6', border: '1px solid rgba(59,130,246,0.12)', padding: '6px 12px', fontSize: '0.75rem', display: 'inline-flex', alignSelf: 'flex-start' }} onClick={(e) => e.stopPropagation()}>
                        Take Action
        ...
        {isCompleted && (
          <div className="animate-fade-up" style={{ padding: '24px', background: '#ECFDF5', borderRadius: '16px', border: '1px solid #D1FAE5', textAlign: 'center', marginTop: '16px' }}>
             ...
             <button onClick={() => goToStep(0)} className="btn-ghost" style={{ background: '#fff', color: '#065F46', border: '1px solid #A7F3D0' }}>
               Restart Guide
             </button>
          </div>
        )}
